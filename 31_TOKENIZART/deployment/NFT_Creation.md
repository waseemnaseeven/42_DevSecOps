...
2. Usage of Solidity Smart Contracts on Openzeppelin
    - Here i can choose the protocol (ERC721) and the features functions for the smart contract
    - I chose : 
        - Ownable so that it has proprietaire
        - Mintable by the owner
        - Pausable by the owner

3. Defined a BaseURI for the NFT (loof at ipfs.md)

4. Usage of Remix to compile my smart contract
    ...
    - Flattened the solidity code for the publish and verification

5. Before deploying, link my meta mask wallet with Sepolia test network
    - I needed to know the chain-id of the sepolia test network

6. Adding at least 0,0001 ETH to have Faucets, test fees (frais transactions) for sepolia testnet
    - I've used Alchemy

7. Deploying my NFT thanks to remix:
