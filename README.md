...
| [cloud-1](https://github.com/waseemnaseeven/42_DevSecOps/24_CLOUD-1) | aws, terraform, ansible | July 2024 | Introduction to cloud servers, such as AWS and automation with terraform and ansible | 100 | 2,5 | ✅ |
| [kernel](https://github.com/waseemnaseeven/42_DevSecOps/25_KERNEL) | Rust, asm, QEMU | It never ends... | Kernel programming from scratch : handling cursor, keyboard entries, reboot, stack dump, global descriptor table...  |  | 3 | ✅ |
