resource "outscale_vm" "vm_haproxy_store1" {
    ...
    tags {
        key   = "name"
        value = "vm_haproxy_store1"
    }
}

output "private_ip_haproxy_store1" {
    description = "private_ip of my haproxy_store1"
    value = outscale_vm.vm_haproxy_store1.private_ip
}