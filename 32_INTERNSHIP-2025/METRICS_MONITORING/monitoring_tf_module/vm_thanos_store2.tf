resource "outscale_vm" "vm_thanos_store2" {
    ...
    tags {
        key   = "name"
        value = "thanos store2 + node_exporter"
    }
}

output "private_ip_thanos_store2" {
    description = "private_ip of my vm_thanos_store2"
    value = outscale_vm.vm_thanos_store2.private_ip
}